...
class Paper extends Component {
    ...
    modernPaperRender() {
        return (<Row>
            <p className="title">Choisis ton papier <span className="hint--top hint--large" aria-label="Ces papiers ont été marbrés à la cuve par les artistes Zeynep Uysal Kog et Katalin Perry."><a href="#">[Plus d'infos]</a></span> :</p>
